    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-accent-50">
      ...
      <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Dissolved Banner */}
          {group.isDissolved && (
            <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-3 rounded-lg">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 mb-3">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h1 className="text-lg font-bold text-gray-900 mb-2">{group.subject} Study Group</h1>
              ...
              <div className="text-right">
                ...
                <p className="text-base font-bold text-gray-900">{group.atRiskStreak}/3</p>
              </div>
            </div>
