...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #f0fdfa 0%, #f0fdf4 50%, #ecfdf5 100%)' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 -mt-20 pb-8 relative z-10">

        {/* ── HEADER CARD ── */}
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-4 mb-3">
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
            ...
            <div className="flex-1 min-w-0 mt-2 sm:mt-0">
              <div className="flex flex-wrap items-center gap-2 mb-1">
                <h1 className="text-lg font-black text-gray-900">{user?.name || 'Your Name'}</h1>
                {user?.cluster?.label && (
